    ...
    <>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <StatusBar
          ...
          backgroundColor={Platform.OS === 'android' ? '#11212D' : 'transparent'}
...
const styles = StyleSheet.create({
  safeArea: {
    flex: 1,
    backgroundColor: '#11212D', // Cor de fundo para iOS (área segura)
  },
  container: {
    flex: 1,
    backgroundColor: '#11212D', // Fundo do aplicativo (Android e iOS)
  },
});
